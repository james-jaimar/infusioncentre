...
- ✅ Phase 1: Auto-create patient from referral (hook + triage dialog button)
- ✅ Phase 2: Messages table migration (with RLS, indexes, realtime)
- ✅ Phase 3: Messaging UI (useMessages hook, ChatThread, ChatInput, ConversationList)
- ✅ Phase 4: Admin messages page (/admin/messages)
