...
export const TOKEN_CSS_VAR: Record<TokenKey, string[]> = {
  ...
  button_primary_hover: ["btn-primary-hover"],
  secondary: ["secondary"],
  ...
  danger_hover: ["destructive-hover", "danger-hover"],
...
export const DEFAULT_TOKENS: Record<TokenKey, string> = {
  ...
  button_primary_hover: "#284B7A",
  secondary: "#F1F4F7",
  secondary_foreground: "#1F3A5F",
  secondary_hover: "#E4EAF0",
  accent: "#1F3A5F",
  link: "#356DA8",
  background: "#E4E9EE",
  card: "#FFFFFF",
  ...
  success_hover: "#256E54",
  warning: "#C48A2D",
  warning_foreground: "#FFFFFF",
  warning_hover: "#A87322",
  danger: "#A23B3B",
...
export const TOKEN_GROUPS: TokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { key: "button_primary_hover", label: "Primary hover", description: "Primary button colour on mouse-over" },
