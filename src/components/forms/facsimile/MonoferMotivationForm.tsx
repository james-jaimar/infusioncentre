...
// Two-column row inside a table-like grid
      ...
      <div className="px-4 pt-3">
        ...
        <div className="border border-border p-3 text-[11px] leading-relaxed text-muted-foreground space-y-2 mb-3">
          ...
          <p className="text-[10px]">
            If yes, please read and complete the Consent Form below, together with the attached Privacy Note on the Processing of Personal Information, marked Annexure "A" ("Privacy Note") and then sign the Consent Form below. This Privacy Note describes how Acino collects and uses your personal information which you may provide to Acino for the Service, upon signing this Consent Form. Therefore, please take your time to read all the following information carefully, and, if you agree, then please sign this Consent Form. Acino will not use nor process your personal information unless you have voluntarily and freely signed this Consent Form.
          </p>
        </div>
        ...
        <div className="text-[11px] leading-relaxed space-y-2 text-muted-foreground mb-3">
          ...
          <p className="text-[10px]">
            For the purpose of this Consent, Confidential/Personal Information shall mean, but not limited to, the Patient's name, Identity Number, Age, Gender, Contact details, Address, Physical or Mental health, well-being, disability, Clinical information and the Patient's medical record relating to the disease.
          </p>
          <p className="text-[10px]">
            I understand and have been provided with a Privacy Note which provides a more complete description on the use, processing and disclosure of my Personal Information. I understand that I have the right to review the said explanatory note prior to signing this consent. I understand that I have the right to object to the use of my Personal Information for purposes other than as explained and stated in this Consent Form. I understand that I have the right to request restrictions as to how my Personal Information may be used or disclosed to carry out treatment, payment, or healthcare operations and that Acino is not required to agree to the restrictions requested. I understand that I may revoke this consent at any time, without any consequences to me.
          </p>
          <p className="text-[10px]">
            I have read this Consent Form and the attached Privacy Note, both of whose contents have been explained to me. I have been given the opportunity to ask questions and my questions have been adequately answered. If I have additional questions, I have been told whom to contact. I hereby freely and voluntarily agree to being provided with the Service and for the Purpose as described above and will receive a copy of this Consent Form.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-3 mb-4">
          <div>
            ...
            <div className="border border-border rounded h-16 mt-1">
              <SignatureCanvas
                value={values.patient_signature || ""}
                onChange={(v) => onChange({ ...values, patient_signature: v })}
                readOnly={readOnly}
              />
            </div>
          </div>
        ...
        <p className="text-[10px] text-muted-foreground py-2 leading-relaxed">
        ...
        <div className="border-t border-border pt-2 pb-3 text-[9px] text-muted-foreground space-y-0.5">
          <p>For full prescribing information refer to the Professional Information approved by the medicines regulatory authority.</p>
  ...
  return (
    <div className="border border-foreground bg-card">
      ...
      <p className="text-[10px] text-muted-foreground px-3 py-1.5">
        Kindly approve reimbursement for the following indication/s for CosmoFer® or Monofer®
      </p>
            ...
            {[
              ...
              <div key={item.name} className="flex items-center gap-2 px-2 py-1 border-b border-border last:border-b-0">
                <Checkbox
                  ...
                  onCheckedChange={(c) => onChange({ ...values, [item.name]: !!c })}
                  disabled={readOnly}
      ...
      <div className="flex items-center gap-4 px-3 py-2 border-b border-border">
        ...
        {["0201", "0206", "5783"].map((code) => (
          <label key={code} className="flex items-center gap-1.5">
            ...
            <Checkbox
              checked={!!values[`proc_${code}`]}
              onCheckedChange={(c) => onChange({ ...values, [`proc_${code}`]: !!c })}
              disabled={readOnly}
              className="h-4 w-4"
            />
          </label>
      ...
      <div className="bg-muted/30 border-b border-border px-3 py-2 text-center">
        <p className="text-xs font-bold">
          IMPORTANT: Please Attach Copies of Latest HB & Iron Studies (not more than 3 months old)
        </p>
      </div>
